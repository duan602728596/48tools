...
import xiaohongshuLiveReducers, {
  ignoredPaths as xiaohongshuLiveIgnoredPaths,
  ignoredActions as xiaohongshuLiveIgnoredActions
} from '../pages/XiaohongshuLive/reducers/xiaohongshuLive';
