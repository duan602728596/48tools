...
import * as kuaishouVideoDownload from './vpTests/kuaishou/kuaishouVideoDownload.vp.test.js';
import * as kuaishouLive from './vpTests/kuaishou/kuaishouLive.vp.test.js';
...
test.describe.parallel('48tools vp test', function(): void {
  ...
  test.describe.serial(kuaishouVideoDownload.title, kuaishouVideoDownload.callback);
  test.describe.serial(kuaishouLive.title, kuaishouLive.callback);
});